...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, last_stride, neck, num_classes=1000,
        ...
        in_feat_size = 512 * block.expansion
        emb_size = int(in_feat_size / red)
        ...
        self.embedding_head = \
            GSP(in_feat_size, emb_size, num_classes) if emb_head.lower() == 'gsp' \
                else LinearNorm(in_feat_size, emb_size, num_classes)

        print('\nINFO::MODEL::EMBEDDING: Using {} ...\n'.format(self.embedding_head.__class__.__name__))
    ...
    def _forward(self, x, output_option='norm', val=False):
        ...
        x_probs, x_emb, x_attr = self.embedding_head(x)
